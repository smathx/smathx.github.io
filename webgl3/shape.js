...
function createObject(name) {
    ...
    obj.fields = function() {
        return [ this.label,
                 ...
                 this.fillColour[3],
                 this.wireframe,
                 this.wireframeColour[0],
                 this.wireframeColour[1],
                 this.wireframeColour[2],
                 this.wireframeColour[3],
                 this.location[0],
                 this.location[1],
                 this.location[2],
                 this.angle[0], 
...
function createTube(num_sides, radius_front, radius_back, height, colour, 
    ...
    for (var i = 0; i < numSegments; ++i) {
        ...
        obj.addTriangle( xf,  yf,  z, xf1, yf1, z, xb1, yb1,  -z);
        
        if (cap_front && (radius_front > 0))
            obj.addTriangle( xf,  yf,  z,  0,  0,  z, xf1, yf1,  z);
...
function createEllipsoid(sizeX, sizeY, sizeZ, numSegments, colour) {
    ...
    var longitudeBands = numSegments;
