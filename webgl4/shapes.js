...
function createShape(type) {
    ...
    obj.addTriangle = function (x1, y1, z1, x2, y2, z2, x3, y3, z3) {
        this.addIndex(this.addVertex(x1, y1, z1));
        this.addIndex(this.addVertex(x2, y2, z2));
        this.addIndex(this.addVertex(x3, y3, z3));
